...
import com.ashadujjaman.cregadmin.ComplaintShowActivity;
...
public class AdapterComplain extends RecyclerView.Adapter<AdapterComplain.HolderViewComplain> {
    ...
    static class HolderViewComplain extends RecyclerView.ViewHolder{
        TextView userNameTv, complainTitleTv, complainTimeTv;

        public HolderViewComplain(@NonNull View itemView) {
            super(itemView);
